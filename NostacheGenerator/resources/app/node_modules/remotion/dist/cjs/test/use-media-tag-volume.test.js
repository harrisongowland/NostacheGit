...
describe('Should update state when volume changes', () => {
    ...
    test('has the volume been set', () => {
        ...
        const { rerender } = (0, react_hooks_1.renderHook)(({ mediaRef }) => (0, use_media_tag_volume_1.useMediaTagVolume)(mediaRef), {
...
test('Should listen for volume changes', () => {
    ...
    (0, react_hooks_1.renderHook)(({ mediaRef }) => (0, use_media_tag_volume_1.useMediaTagVolume)(mediaRef), {
        initialProps: { mediaRef: audioRef },
    });
    expect(addEventListener).toHaveBeenCalledTimes(1);
});
//# sourceMappingURL=use-media-tag-volume.test.js.map