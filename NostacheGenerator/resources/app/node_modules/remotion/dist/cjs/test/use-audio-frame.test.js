...
test('Media starts at 0 if it is outside a sequence', () => {
    ...
    const { result } = (0, react_hooks_1.renderHook)(() => (0, use_audio_frame_1.useMediaStartsAt)(), { wrapper });
...
describe('useFrameForVolumeProp hook tests', () => {
    ...
    test('Media not mounted', () => {
        ...
        const { result } = (0, react_hooks_1.renderHook)(() => (0, use_audio_frame_1.useFrameForVolumeProp)());
...
//# sourceMappingURL=use-audio-frame.test.js.map